...
const Rules = () => {
    useEffect(() => {
        ...
        modal.innerText = "MTG Cleaver Road Group Rules";
    });
        ...
        <div className="container__rules">
          ...
          <div id="maincontainer" className="rulecontainer">              
            <article>
              ...
              <ul>
                <li>
                  ...
                  Ovewhelming strategies or powerful cards can make playing mtg
                  a chore rather than recreation. Tournament level cards and
                ...
                <li>
                  ...
                  experience and it will suck is someone just comes along an
                  adds it to their deck. So when fixing your own deck try to
                  ovoid using cards that are unique to another player's deck.
                  When in doubt just ask them. stay away from key
                </li>
                <li>
                  <b>Don't break Cards</b>
                  <br />
                  Its impossible to know how every card interacts with each
                  other. We have tried to ban what we believe to the most unfun
                  or non-fairplay cards in Modern MTG. Yet there are going to be
                  cards we missed. Others we left because we hope people will
                  use them fairly. If this is not the case then those cards will
                  be banned immediately. Reguardless if they are in someone's
                  deck. Desicions on these bans will be made democractically by
                  the group.
                </li>
              </ul>
            </article>
            ...
            <ul>
              ...
              <li>
                Mass Removal - that removes everthing from the battlefield
              </li>
            </ul>
          </div>
        </div>
